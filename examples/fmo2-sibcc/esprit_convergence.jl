...
for tolerance in ESPRIT_TOLERANCES
    ...
    println("  final populations: rho11=$(populations[1, end]), rho22=$(populations[2, end])")
...
open(summary_file, "w") do io
    println(io, "# tolerance terms_per_bath bcf_l2_error bcf_max_error nondecaying_poles expanded_heom_terms nado rho11_final rho22_final max_population_difference_vs_tol_5e-03")
